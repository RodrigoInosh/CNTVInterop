...
@XmlRootElement(name = "agregarUsuarioResponse", namespace = "http://cntv.interop.subtel.cl/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "agregarUsuarioResponse", namespace = "http://cntv.interop.subtel.cl/")
